...
every time one is inserted or removed. Phase 0 entries are Terraform ordering
races; later phases will add sync and Conditional Access failures here.
...
a time. Basic would give concurrent sessions at $0.19/hour, about $139/month
billed 24/7 with no auto-shutdown, roughly ten times the VM bill. Verified against
the Azure Retail Prices API. Not worth it for a lab.
